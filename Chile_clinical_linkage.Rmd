...
#sort(unique(c(clinical_small$codigo, clinical_small$cod_dg_2, clinical_small$cod_dg_3)))
...
patients <- clinical %>%
  group_by(id, gender, commune_name, region_name, dob, ses_status) %>%
  ...
  select(row_id, id, dob, sex_desc, student_commune_name, ses_status) #, student_region_name) #, count)
