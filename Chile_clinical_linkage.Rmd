                                   ...
                                   ifelse(socio_economic_level == "FONASA - C", 2, 
                                          ifelse(socio_economic_level == "FONASA - D", 2,
                                                 ifelse(socio_economic_level == "Private Health Insurance", 3, 
                                                        ifelse(socio_economic_level %in% c("COLMENA GOLDEN CROSS", "RIO BLANCO", "CARABINEROS (DIPRECA)", "BANMEDICA S.A.", "PARTICULAR (SIN PREVISION)", "VIDA TRES"), NA, NA)))))),
         autism = 1,
         intdisab = 0,
         aut_rank = 1
         ) %>%
...
```{r kolmogorov tests}
data1 <- school_matched_yes$ses_status.school
data2 <- school_matched_no$ses_status.school
ks.test(data1, data2)
