...
```{r mcaNoimpGraph, fig.cap="Contribution of the top 15 categories to the first two dimensions of MCA., fig.height = 4}

# Total contribution to dimension 1 and 2
fviz_contrib(res_mca_patients_noimp, choice = "var", axes = 1:2, top = 15) +
  labs(title = "Contribution of categories, no imputation",
       x = "Category",
       y = "Contribution (%)")
```
...
school[dim(school)[1]+1, ] <- c(dim(school)[1]+1, "2023-06-26", "Female", "Misc", 0, 3, 2)
```
