...
aut_prev_econA.age_f.table <- aut_prev_econA.age_sex %>% filter(sex_desc == "Female") %>%
  select(school_fee, age_june30, n_disease, prev_ci)
aut_prev_econA.age_m.table <- aut_prev_econA.age_sex %>% filter(sex_desc == "Male") %>%
  select(school_fee, age_june30, n_disease, prev_ci)

kables(list(kable(aut_prev_econA.age_f.table, 
                  col.names = c("School fee", "Age band", "Autism cases", "Prevalence % (95% CI)"),
                  align = "rrr"),
            kable(aut_prev_econA.age_m.table,
                  col.names = c("School fee", "Age band", "Autism cases", "Prevalence % (95% CI)"),
                  align = "rrr")),
            caption = "Count and prevalence of autism cases by monthly school fees (Peso) and age in Chile school data for females (left) and males (right) with normal confidence intervals.")
...
adhd_prev_econA.age_f.table <- adhd_prev_econA.age_sex %>% filter(sex_desc == "Female") %>%
  select(school_fee, age_june30, n_disease, prev_ci)
adhd_prev_econA.age_m.table <- adhd_prev_econA.age_sex %>% filter(sex_desc == "Male") %>%
  select(school_fee, age_june30, n_disease, prev_ci)

kables(list(kable(adhd_prev_econA.age_f.table, 
                  col.names = c("School fee", "Age band", "ADHD cases", "Prevalence % (95% CI)"),
                  align = "rrr"),
            kable(adhd_prev_econA.age_m.table,
                  col.names = c("School fee", "Age band", "ADHD cases", "Prevalence % (95% CI)"),
                  align = "rrr")),
            caption = "Count and prevalence of ADHD cases by monthly school fees (Peso) and age in Chile school data for females (left) and males (right) with normal confidence intervals.")

```

```{r adj prev econA plot aut agecat, fig.cap = "Sample prevalence of autism by socio-economic (SES) status of student's family, age band and sex. Bars show 95% normal confidence intervals."}
# Autism
...
```{r adj prev econA plot adhd agecat, fig.cap = "Sample prevalence of ADHD by socio-economic (SES) status of student's family, age band and sex. Bars show 95% normal confidence intervals."}
# ADHD
...
aut_prev_ethnic.age_f.table <- aut_prev_ethnic.age_sex %>% filter(sex_desc == "Female") %>%
  select(ethnic_2_group, age_june30, n_disease, prev_ci)
aut_prev_ethnic.age_m.table <- aut_prev_ethnic.age_sex %>% filter(sex_desc == "Male") %>%
  select(ethnic_2_group, age_june30, n_disease, prev_ci)

kables(list(kable(aut_prev_ethnic.age_f.table, 
                  col.names = c("Ethnicity", "Age band", "Autism cases", "Prevalence % (95% CI)"),
                  align = "rrr"),
            kable(aut_prev_ethnic.age_m.table,
                  col.names = c("Ethnicity", "Age band", "Autism cases", "Prevalence % (95% CI)"),
                  align = "rrr")),
            caption = "Count and prevalence of autism cases by ethnicity and age in Chile school data for females (left) and males (right) with normal confidence intervals.")
...
adhd_prev_ethnic.age_f.table <- adhd_prev_ethnic.age_sex %>% filter(sex_desc == "Female") %>%
  select(ethnic_2_group, age_june30, n_disease, prev_ci)
adhd_prev_ethnic.age_m.table <- adhd_prev_ethnic.age_sex %>% filter(sex_desc == "Male") %>%
  select(ethnic_2_group, age_june30, n_disease, prev_ci)

kables(list(kable(adhd_prev_ethnic.age_f.table, 
                  col.names = c("Ethnicity", "Age band", "ADHD cases", "Prevalence % (95% CI)"),
                  align = "rrr"),
            kable(adhd_prev_ethnic.age_m.table,
                  col.names = c("Ethnicity", "Age band", "ADHD cases", "Prevalence % (95% CI)"),
                  align = "rrr")),
            caption = "Count and prevalence of ADHD cases by ethnicity and age in Chile school data for females (left) and males (right) with normal confidence intervals.")

```


```{r adj prev ethnic plot aut agecat, fig.cap = "Sample prevalence of autism by ethnicity, age band and sex. Bars show 95% normal confidence intervals."}
# Autism
aut_prev_ethnic.agecat_sex <- get_grouped_prev_plot(x = chile_bayes_aut,
...
```{r adj prev ethnic plot adhd agecat, fig.cap = "Sample prevalence of ADHD by ethnicity, age band and sex. Bars show 95% normal confidence intervals."}
# ADHD
adhd_prev_ethnic.agecat_sex <- get_grouped_prev_plot(x = chile_bayes_adhd,
...
aut_prev_rural.age_f.table <- aut_prev_rural.age_sex %>% filter(sex_desc == "Female") %>%
  select(school_rurality, age_june30, n_disease, prev_ci)
aut_prev_rural.age_m.table <- aut_prev_rural.age_sex %>% filter(sex_desc == "Male") %>%
  select(school_rurality, age_june30, n_disease, prev_ci)

kables(list(kable(aut_prev_rural.age_f.table, 
                  col.names = c("School's rurality", "Age band", "Autism cases", "Prevalence % (95% CI)"),
                  align = "rrr"),
            kable(aut_prev_rural.age_m.table,
                  col.names = c("School's rurality", "Age band", "Autism cases", "Prevalence % (95% CI)"),
                  align = "rrr")),
            caption = "Count and prevalence of autism cases by rurality of studnets' school and age in Chile school data for females (left) and males (right) with normal confidence intervals.")
...
adhd_prev_rural.age_f.table <- adhd_prev_rural.age_sex %>% filter(sex_desc == "Female") %>%
  select(school_rurality, age_june30, n_disease, prev_ci)
adhd_prev_rural.age_m.table <- adhd_prev_rural.age_sex %>% filter(sex_desc == "Male") %>%
  select(school_rurality, age_june30, n_disease, prev_ci)

kables(list(kable(adhd_prev_rural.age_f.table, 
                  col.names = c("School's rurality", "Age band", "ADHD cases", "Prevalence % (95% CI)"),
                  align = "rrr"),
            kable(adhd_prev_rural.age_m.table,
                  col.names = c("School's rurality", "Age band", "ADHD cases", "Prevalence % (95% CI)"),
                  align = "rrr")),
            caption = "Count and prevalence of ADHD cases by rurality of students' school and age in Chile school data for females (left) and males (right) with normal confidence intervals.")
...
Text about adjusted prevalence
...
aut_prev_ethnic_adj.long_plot <- ggplot(data = aut_prev_ethnic_adj.long) +
  geom_col(aes(x = type, y = rate, fill = type), position = position_dodge(), show.legend = TRUE) +
  geom_errorbar(aes(x = type, ymin = ci_lower, ymax = ci_upper, group = type), width = 0.2, position = position_dodge(width = 0.9)) +
  theme(axis.title.x = element_blank(),
        axis.title.y = element_blank()) +
...
adhd_prev_ethnic_adj.long_plot <- ggplot(data = adhd_prev_ethnic_adj.long) +
  geom_col(aes(x = type, y = rate, fill = type), position = position_dodge(), show.legend = TRUE) +
  geom_errorbar(aes(x = type, ymin = ci_lower, ymax = ci_upper, group = type), width = 0.2, position = position_dodge(width = 0.9)) +
  theme(axis.title.x = element_blank(),
        axis.title.y = element_blank()) +
...
```{r adj prev araucS plot aut age, fig.cap = "Sample prevalence of autism by commune in Araucanía Sur health service, age and sex. Bars show 95% normal confidence intervals.", include=FALSE}
# Single ages
...
```{r bayes araucS aut, fig.cap = "Posterior predictive distribution for autism with a random effect on commune within Araucanía Sur health service, and with age- and sex-adjusted global prevalence prior.", include=FALSE}
