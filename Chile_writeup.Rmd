...
chile_bayes <- chile_merged %>%
  ...
  mutate(autism = ifelse(special_needs_code == 105, 1, 0),
         ...
         ethnic_2_group = ifelse(ethnicity == "Mapuche", "Mapuche", 
...
viridis_colours <- viridis(10, option = "G")
...
Autism prevalence is `r round(chile_bayes_aut %>% filter(autism == 1, sex_desc == "Female") %>% nrow() / chile_bayes_aut %>% filter(sex_desc == "Female") %>% nrow() * 100, 2)`% for females and `r sprintf("%.2f", round(chile_bayes_aut %>% filter(autism == 1, sex_desc == "Male") %>% nrow() / chile_bayes_aut %>% filter(sex_desc == "Male") %>% nrow() * 100, 2))`% for males. 

ADHD prevalence is `r round(chile_bayes_adhd %>% filter(adhd == 1, sex_desc == "Female") %>% nrow() / chile_bayes_adhd %>% filter(sex_desc == "Female") %>% nrow() * 100, 2)`% for females and `r sprintf("%.2f", round(chile_bayes_adhd %>% filter(adhd == 1, sex_desc == "Male") %>% nrow() / chile_bayes_adhd %>% filter(sex_desc == "Male") %>% nrow() * 100, 2))`% for males. 

Autism and ADHD prevalences are higher in males than females for all ages.

```{r prev plot sex agecat, fig.cap = "Sample prevalence of autism and ADHD by age band and sex. Bars show 95% normal confidence intervals.", fig.height = 5}
# Autism
...
aut_prev.age_f.table <- aut_prev.age_sex %>% filter(sex_desc == "Female") %>%
  select(age_june30, n_disease, prev_ci)
aut_prev.age_m.table <- aut_prev.age_sex %>% filter(sex_desc == "Male") %>%
  select(age_june30, n_disease, prev_ci)

kables(list(kable(aut_prev.age_f.table, 
                  col.names = c("Age band", "Autism cases", "Prevalence % (95% CI)"),
                  align = "rrr"),
            kable(aut_prev.age_m.table,
                  col.names = c("Age band", "Autism cases", "Prevalence % (95% CI)"),
                  align = "rrr")),
            caption = "Count and prevalence of autism cases by age in Chile school data for females (left) and males (right) with normal confidence intervals.")
...
adhd_prev.age_f.table <- adhd_prev.age_sex %>% filter(sex_desc == "Female") %>%
  select(age_june30, n_disease, prev_ci)
adhd_prev.age_m.table <- adhd_prev.age_sex %>% filter(sex_desc == "Male") %>%
  select(age_june30, n_disease, prev_ci)

kables(list(kable(adhd_prev.age_f.table, 
                  col.names = c("Age band", "ADHD cases", "Prevalence % (95% CI)"),
                  align = "rrr"),
            kable(adhd_prev.age_m.table,
                  col.names = c("Age band", "ADHD cases", "Prevalence % (95% CI)"),
                  align = "rrr")),
            caption = "Count and prevalence of ADHD cases by age in Chile school data for females (left) and males (right) with normal confidence intervals.")

kable(list(adhd_prev.age_f.table, adhd_prev.age_m.table),
      col.names = c("Age band", "ADHD cases", "Prevalence % (95% CI)"),
      align = "rrr",
      valign = 't',
      caption = "Count and prevalence of ADHD cases by age in Chile school data for females (left) and males (right) with normal confidence intervals.")
...
For school fees, which are used here as a proxy for SES, autism prevalence is highest, at ..., among  Autism prevalence is `r round(chile_bayes_aut %>% filter(autism == 1, sex_desc == "Female") %>% nrow() / chile_bayes_aut %>% filter(sex_desc == "Female") %>% nrow() * 100, 2)`% for females and `r sprintf("%.2f", round(chile_bayes_aut %>% filter(autism == 1, sex_desc == "Male") %>% nrow() / chile_bayes_aut %>% filter(sex_desc == "Male") %>% nrow() * 100, 2))`% for males. 

ADHD prevalence is `r round(chile_bayes_adhd %>% filter(adhd == 1, sex_desc == "Female") %>% nrow() / chile_bayes_adhd %>% filter(sex_desc == "Female") %>% nrow() * 100, 2)`% for females and `r sprintf("%.2f", round(chile_bayes_adhd %>% filter(adhd == 1, sex_desc == "Male") %>% nrow() / chile_bayes_adhd %>% filter(sex_desc == "Male") %>% nrow() * 100, 2))`% for males. 

Autism and ADHD prevalences are higher in males than females for all ages.

```{r prev table health agecat, fig.cap = "Sample prevalence of autism and ADHD by health service, age band and sex. Bars show 95% normal confidence intervals.", fig.height = 5}
# Autism
...
aut_prev_health.age_f.table <- aut_prev_health.age_sex %>% filter(sex_desc == "Female") %>%
  select(health_service_name, age_june30, n_disease, prev_ci)
aut_prev_health.age_m.table <- aut_prev_health.age_sex %>% filter(sex_desc == "Male") %>%
  select(health_service_name, age_june30, n_disease, prev_ci)

kables(list(kable(aut_prev_health.age_f.table, 
                  col.names = c("Health service", "Age band", "Autism cases", "Prevalence % (95% CI)"),
                  align = "rrr"),
            kable(aut_prev_health.age_m.table,
                  col.names = c("Health service", "Age band", "Autism cases", "Prevalence % (95% CI)"),
                  align = "rrr")),
            caption = "Count and prevalence of autism cases by health service and age in Chile school data for females (left) and males (right) with normal confidence intervals.")
...
adhd_prev_health.age_f.table <- adhd_prev_health.age_sex %>% filter(sex_desc == "Female") %>%
  select(health_service_name, age_june30, n_disease, prev_ci)
adhd_prev_health.age_m.table <- adhd_prev_health.age_sex %>% filter(sex_desc == "Male") %>%
  select(health_service_name, age_june30, n_disease, prev_ci)

kables(list(kable(adhd_prev_health.age_f.table, 
                  col.names = c("Health service", "Age band", "ADHD cases", "Prevalence % (95% CI)"),
                  align = "rrr"),
            kable(adhd_prev_health.age_m.table,
                  col.names = c("Health service", "Age band", "ADHD cases", "Prevalence % (95% CI)"),
                  align = "rrr")),
            caption = "Count and prevalence of ADHD cases by health service and age in Chile school data for females (left) and males (right) with normal confidence intervals.")

kable(list(adhd_prev_health.age_f.table, adhd_prev_health.age_m.table),
      col.names = c("Health services", "Age band", "ADHD cases", "Prevalence % (95% CI)"),
      align = "rrr",
      valign = 't',
      caption = "Count and prevalence of ADHD cases by health service and age in Chile school data for females (left) and males (right) with normal confidence intervals.")
...
```{r adj prev plot health agecat aut, fig.cap = "Sample prevalence of autism by health service, age band and sex. Bars show 95% normal confidence intervals.", fig.height = 12}
# Autism
...
```{r adj prev plot health agecat adhd, fig.cap = "Sample prevalence of ADHD by health service, age band and sex. Bars show 95% normal confidence intervals.", fig.height = 12}
# ADHD
...
Grouping features of sex, health service of residential commune, monthly school fee as a proxy for SES, ethnicity and school’s rurality were used, and calculations were made for aggregate, by sex, and by sex and age group.
...
fviz_mca_var(res_mca_patients_noimp,
             ...
             gradient.cols = c(viridis_colours[1], viridis_colours[5], viridis_colours[7]),
...
```{r adj prev plot aut sex, fig.cap = "Sample prevalence of autism by age and sex. Bars show 95% normal confidence intervals."}
# Autism
