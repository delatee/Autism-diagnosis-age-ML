...
The small and large clinical datats will be collectively referred to as the clinical data and they do not include any records for privately provided healthcare.
...
Autism and ADHD are slightly more prevalent for students at rural schools and both follow the same age patterns observed earlier. See Tables \@ref(tab:prevAgeRuralAutTable) and \@ref(tab:prevAgeRuralAdhdTable), Figures \@ref(fig:prevAgecatRuralAutPlot) and \@ref(tab:prevAgecatRuralAdhdPlot) and Supplementary Figures \@ref(fig:prevAgeRuralAutPlot) and \@ref(tab:prevAgeRuralAdhdPlot).
