...
Analysis of differences between matched and unmatched records in the school data and in the patient data by sex, commune and proxy for SES are provided as Supplementary Figures \@ref(fig:kolmogorovSchoolSex)-\@ref(fig:kolmogorovSchoolSes) (school data) and \@ref(fig:kolmogorovPatientSex)-\@ref(fig:kolmogorovPatientSes) (patient data).
