...
get_adjusted_prev <- function(x, grouping_vars) {
  # Turns grouped prevalences into age- and sex- adjusted prevalences with
...
plot_post_density <- function(jags_post, sample_data, feat, theta_mu, theta_sigma,
  ...
  # sample data = output from get_adjusted_prev, ie sample prevalences with
...
Four priors for $\theta_{i}$ were used when fitting the Bayesian prevalence model. First, a conjugate beta prior common to all health services was constructed with the national age- and sex-adjusted prevalence of autism in the school dataset and its standard deviation used respectively as the mean and standard deviation of the prior. This prior was suitable because the national adjusted prevalence in the school data provides a lower bound on the plausible prevalence of autism in Chile. 
...
Given the prevalences of autism and ADHD in this data are likely to be underestimates, the age- and sex-adjusted prevalences can be considered a lower bound on the true prevalence of autism and of ADHD in Chile. 
...
```{r prevAgeAutPlot, fig.cap = "Crude prevalence of autism in school data by age band. Bars show 95% normal confidence intervals.", fig.height=3, fig.pos='H'}
...
```{r prevAgeAdhdPlot, fig.cap = "Crude prevalence of ADHD in school data by age band. Bars show 95% normal confidence intervals.", fig.height=3}
...
```{r prevAgeSexAutPlot, fig.cap = "Crude prevalence of autism in school data by age and sex. Bars show 95% normal confidence intervals.", fig.height=3}
# Autism
...
```{r prevAgeSexAdhdPlot, fig.cap = "Crude prevalence of ADHD in school data by age and sex. Bars show 95% normal confidence intervals.", fig.height=3}
# ADHD
...
```{r prevAgeHealthAutPlot, fig.cap = "Crude prevalence of autism in school data by health service, age and sex. Bars show 95% normal confidence intervals.", fig.height=10, fig.width=8.5}
# Single ages
...
```{r prevAgeHealthAdhdPlot, fig.cap = "Crude prevalence of ADHD in school data by health service, age and sex. Bars show 95% normal confidence intervals.", fig.height=10, fig.width=8.5}
# Single ages
...
```{r prevAgeEconAAutPlot, fig.cap = "Crude prevalence of autism in school data by socio-economic (SES) status of student's family, age and sex. Bars show 95% normal confidence intervals.", fig.height=6}
# Single ages
...
```{r prevAgeEconAAdhdPlot, fig.cap = "Crude prevalence of ADHD in school data by socio-economic (SES) status of student's family, age and sex. Bars show 95% normal confidence intervals.", fig.height=6}
# Single ages
...
```{r prevAgeEthnicAutPlot, fig.cap = "Crude prevalence of autism in school data by ethnicity, age and sex. Bars show 95% normal confidence intervals.", fig.height=3}
# Single ages
...
```{r prevAgeEthnicAdhdPlot, fig.cap = "Crude prevalence of ADHD in school data by ethnicity, age and sex. Bars show 95% normal confidence intervals.", fig.height=3}
# Single ages
...
```{r prevAgeRuralAutPlot, fig.cap = "Crude prevalence of autism in school data by school's rurality, age and sex. Bars show 95% normal confidence intervals.", fig.height=3}
# Single ages
...
```{r prevAgeRuralAdhdPlot, fig.cap = "Crude prevalence of ADHD in school data by school's rurality, age and sex. Bars show 95% normal confidence intervals.", fig.height=3}
# Single ages
