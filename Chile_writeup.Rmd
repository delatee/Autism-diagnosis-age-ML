...
aut_prev_adj.long_plot <- ggplot(data = aut_prev_adj.long) +
  geom_col(aes(x = type, y = rate, fill = type), position = position_dodge(), show.legend = FALSE) +
...
grid.arrange(aut_prev_adj.long_plot, aut_prev_adj_b.long_plot, ncol = 2)
...
grid.arrange(adhd_prev_adj.long_plot, adhd_prev_adj_b.long_plot, ncol = 2)
