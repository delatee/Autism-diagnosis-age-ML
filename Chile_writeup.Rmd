...
viridis_colours <- viridis(10, option = "G") #"#0B0405FF" "#28192FFF" "#3B2F5EFF" "#40498EFF" "#366A9FFF" "#348AA6FF" "#38AAACFF" "#54C9ADFF" "#A0DFB9FF" "#DEF5E5FF"
turbo_colours <- viridis(10, option = "H") #"#30123BFF" "#4662D7FF" "#36AAF9FF" "#1AE4B6FF" "#72FE5EFF" "#C7EF34FF" "#FABA39FF" "#F66B19FF" "#CB2A04FF" "#7A0403FF"
...
```{r mcaNoimpFeatures, fig.cap="Categorical features of the small clinical dataset by its first two dimensions after multiple correspondence analysis."}
# Plot features
fviz_mca_var(res_mca_patients_noimp, 
             choice = "mca.cor", 
             labelsize = 4, 
             pointsize = 3, 
             col.var = turbo_colours[9],
             repel = TRUE, # Avoid text overlapping
             ggtheme = theme_minimal()) +
  labs(title = "Categorical features by first two dimensions, no imputation")
```

```{r mcaNoimpCategories, fig.cap="The available categories of the categorical features of the small clinical dataset by its first two dimensions after multiple correspondence analysis. Colour shows the category's contribution to the first two dimensions.", fig.height=11}
# Plot categories
grid.arrange(fviz_mca_var(res_mca_patients_noimp,
             col.var = "contrib",
             labelsize = 4, 
             pointsize = 3, 
             gradient.cols = c(turbo_colours[2], turbo_colours[4], turbo_colours[8]),
             repel = TRUE, # Avoid text overlapping (slow if many points)
             ggtheme = theme_minimal()) +
  labs(title = "Categories of features, no imputation",
       colour = "Contribution"),

# Total contribution to dimension 1 and 2
fviz_contrib(res_mca_patients_noimp, choice = "var", axes = 1:2, top = 15), nrow = 2)
```
...
mca_noimp_age_plot <- fviz_mca_ind(res_mca_patients_noimp, 
             label = "none", # hide individual labels
             habillage = "Age band", # color by groups 
...
mca_noimp_commune_plot <- fviz_mca_ind(res_mca_patients_noimp, 
             label = "none", # hide individual labels
             habillage = "Commune", # color by groups 
             #palette = c("#00AFBB", "#E7B800"),
             addEllipses = TRUE, ellipse.type = "confidence",
...
mca_noimp_ses_plot <- fviz_mca_ind(res_mca_patients_noimp, 
             label = "none", # hide individual labels
             habillage = "Health insurance", # color by groups 
             #palette = c("#00AFBB", "#E7B800"),
             addEllipses = TRUE, ellipse.type = "confidence",
...
mca_noimp_foster_plot <- fviz_mca_ind(res_mca_patients_noimp, 
             label = "none", # hide individual labels
             habillage = "Foster care", # color by groups 
             #palette = c("#00AFBB", "#E7B800"),
             addEllipses = TRUE, ellipse.type = "confidence",
...
grid.arrange(mca_noimp_aut_plot)
...
res_mca_patients_aut <- FactoMineR::MCA(patients_mca_aut, # Can only take categorical variables and they have to be cast to factors
                                    ncp = 4, # Needs to match number of features
                                    graph = FALSE) 

# Plot features
fviz_mca_var(res_mca_patients_aut, choice = "mca.cor", 
            repel = TRUE, # Avoid text overlapping
            ggtheme = theme_minimal())
...
mca_aut_age_plot <- fviz_mca_ind(res_mca_patients_aut, 
             ...
             title = "Patients by age",
             ggtheme = theme_minimal())
# mca_aut_aut_plot <- fviz_mca_ind(res_mca_patients_aut,
#              label = "none", # hide individual labels
#              habillage = "autism", # color by groups
#              #palette = c("#00AFBB", "#E7B800"),
#              addEllipses = TRUE, ellipse.type = "confidence",
...
# 
# # Contributions of variable categories to dimension 1
fviz_contrib(res_mca_patients_aut, choice = "var", axes = 1, top = 15) 
# # Contributions of variable categories to dimension 2
fviz_contrib(res_mca_patients_aut, choice = "var", axes = 2, top = 15)
# # Total contribution to dimension 1 and 2
