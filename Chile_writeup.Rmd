...
```{r prev agecat plot, fig.cap = "Sample prevalence of autism and ADHD by age band. Bars show 95% normal confidence intervals.", fig.height = 4}
...
```{r prev agecat sex plot, fig.cap = "Sample prevalence of autism and ADHD by age band and sex. Bars show 95% normal confidence intervals.", fig.height = 4}
...
kbl(aut_prev_health.age_sex.table, 
  ...
  linesep = c("", "", "", "", "",
              ...
              "", "", "", "", "",
              "", "", "", "", "",
              "", "", "", "\\hline"), # Extra white space after every 29th line
...
```{r prev agecat health aut plot, fig.cap = "Sample prevalence of autism by health service, age band and sex. Bars show 95% normal confidence intervals.", fig.height = 10, fig.width = 8.5}
# Autism
...
```{r prev agecat health adhd plot, fig.cap = "Sample prevalence of ADHD by health service, age band and sex. Bars show 95% normal confidence intervals.", fig.height = 10, fig.width = 8.5}
# ADHD
...
kbl(aut_prev_econA.age_sex.table, 
  ...
  booktabs = TRUE,
  longtable = TRUE,
  linesep = c("", "", "", "", "", "", "\\hline"), # Extra white space after every 7th line
...
```{r prev agecat econA aut plot, fig.cap = "Sample prevalence of autism by student's monthly school fee (Peso), age band and sex. Bars show 95% normal confidence intervals.", fig.height=6}
# Autism
...
```{r prev agecat econA adhd plot, fig.cap = "Sample prevalence of ADHD by student's monthly school fee (Peso), age band and sex. Bars show 95% normal confidence intervals.", fig.height=6}
# ADHD
...
Autism prevalence is slightly lower among Mapuche students than students with no Indigenous group, and slightly higher in those belonging to another Indigenous group, but age distribution is consistent across ethnicities. ADHD prevalence is also consistent across ethnic groups with slightly higher prevalence in older non-Indigenous students compared to Indigenous.

```{r prev age ethnic aut table}
# Autism
...
kbl(aut_prev_ethnic.age_sex.table, 
  ...
  booktabs = TRUE,
  longtable = TRUE,
  linesep = c("", "", "\\hline"), # Extra white space after every 3rd line
  caption = "Count and prevalence of Autism cases by ethnicity and age in Chile school data for females and males with normal confidence intervals.") %>%
  add_header_above(c(" " = 2, "Female" = 2, "Male" = 2)) %>%
  kable_styling(latex_options = c("repeat_header"))
```

```{r prev age ethnic adhd table}
# Autism
...
kbl(adhd_prev_ethnic.age_sex.table, 
  ...
  longtable = TRUE,
  linesep = c("", "", "\\hline"), # Extra white space after every 3rd line
  caption = "Count and prevalence of ADHD cases by ethnicity and age in Chile school data for females and males with normal confidence intervals.") %>%
add_header_above(c(" " = 2, "Female" = 2, "Male" = 2)) %>%
  kable_styling(latex_options = c("repeat_header"))
```

```{r prev agecat ethnic aut plot, fig.cap = "Sample prevalence of autism by ethnicity, age band and sex. Bars show 95% normal confidence intervals."}
# Autism
...
```{r prev agecat ethnic adhd plot, fig.cap = "Sample prevalence of ADHD by ethnicity, age band and sex. Bars show 95% normal confidence intervals."}
# ADHD
...
Autism and ADHD are slightly more prevalence for students at rural schools and both follow the same age patterns observed earlier.

```{r prev age rural aut table}
# Autism
...
kbl(aut_prev_rural.age_sex.table, 
  ...
  booktabs = TRUE,
  #longtable = TRUE,
  linesep = c("", "\\hline"), # Extra white space after every 2nd line
...
```{r prev agecat rural aut plot, fig.cap = "Sample prevalence of autism by school's rurality, age band and sex. Bars show 95% normal confidence intervals."}
# Autism
...
```{r prev agecat rural adhd plot, fig.cap = "Sample prevalence of ADHD by school's rurality, age band and sex. Bars show 95% normal confidence intervals."}
# By age and sex
# Age categories
