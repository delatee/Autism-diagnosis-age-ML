...
For school fees, which are used here as a proxy for SES, autism prevalence was highest among students that received free or low fee education, though the sample size for students that paid \$1,000-\$10,000 monthly was very small, see Table \@ref(tab:adjPrevEconAAutTable). ADHD prevalence was variable across school fee levels, with the \$1,000-\$10,000 band having low prevalence and very few cases, see Table \@ref(tab:adjPrevEconAdhdTable). For both autism and ADHD, prevalence is very low among students paying more than \$100,000 monthly, suggesting students from wealthier families may not be accessing SEED or may not be eligible for it due to attending non-subsidised private schools. See also Supplementary Tables \@ref(tab:prevAgecatEconAAutTable) and \@ref(tab:prevAgecatEconAAdhdTable) and Supplementary Figures \@ref(fig:prevAgecatEconAAutPlot), \@ref(fig:prevAgecatEconAAdhdPlot), \@ref(fig:prevAgeEconAAutPlot) and \@ref(fig:prevAgeEconAAdhdPlot).
...
aut_prev_ethnic.agecat_sex.table <- aut_prev_ethnic.agecat_sex %>% 
  ...
  cbind(aut_prev_ethnic.agecat_sex %>% 
          filter(sex_desc == "Male") %>% 
          mutate(ifelse(n_disease < 20, "<20", n_disease)) %>%
          select(n_disease=m, prev_ci))
