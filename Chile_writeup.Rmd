...
The prevalence of autism and ADHD in Chile has not been well characterised and therefore the unmet need of affected children without school-based support is unknown. This investigation aims to quantify the prevalence of autism and ADHD in Chilean children and understand the characteristics of children with autism through analysis of 3 million school records and linkage to 1,300 supplementary clinical records. Found using frequentist age- and sex-adjustment, a lower bound on the prevalence of autism is 0.46% with male to female ratio of 6.00:1 and a lower bound on the prevalence of ADHD 1.50% with male to female ratio of 1.94:1. Autism prevalence peaks in 6-8 year-olds and ADHD in 9-11 year-olds. For both autism and ADHD, prevalence is lower among Mapuche students than non-Indigenous students and is lower among students at urban schools than rural schools. Multiple correspondence analysis of categories in clinical autism diagnosis data for Servicio de Salud Araucanía Sur showed ethnicity, age and commune of residence were important in distinguishing between patients with autism. Probabilistic linkage of school records and clinical autism diagnoses identified an unmet need of 1,132 students with autism in Servicio de Salud Araucanía Sur that were not accessing school-based supports. This equated to an updated autism prevalence of 1.22% with male to female ratio of 4.18 for Servicio de Salud Araucanía Sur. Projecting this finding across Chile, the national prevalence of autism is estimated to be 1.31%, there is an unmet need of up to 25,903 students not accessing school support with females disproportionately affected. Bayesian prevalence projection found credible intervals of autism prevalence for each Chilean health service. Collectively, these findings are a first step to creating a rich, national picture of autism and ADHD support in Chile.
...
```{r prevAgeAutPlot, include = FALSE, fig.cap = "Crude prevalence of autism in school data by age band. Bars show 95% normal confidence intervals.", fig.height=3, fig.pos='H'}
...
```{r prevAgeAdhdPlot, include = FALSE, fig.cap = "Crude prevalence of ADHD in school data by age band. Bars show 95% normal confidence intervals.", fig.height=3}
...
```{r prevAgeSexAutPlot, include = FALSE, fig.cap = "Crude prevalence of autism in school data by age and sex. Bars show 95% normal confidence intervals.", fig.height=3}
# Autism
...
```{r prevAgeSexAdhdPlot, include = FALSE, fig.cap = "Crude prevalence of ADHD in school data by age and sex. Bars show 95% normal confidence intervals.", fig.height=3}
# ADHD
...
```{r prevAgecatHealthAutPlot, fig.cap = "Crude prevalence of autism in school data by health service, age band and sex. Bars show 95% normal confidence intervals.", fig.height = 10, fig.width = 8.5}
# Autism
aut_prev_health.agecat_sex <- get_grouped_prev_plot(x = chile_bayes_aut, 
                                          grouping_vars = c("health_service_name" ,"age_cat_name", "sex_desc", "autism"),
                                          disease = "autism") %>%
...
```{r prevAgecatHealthAdhdPlot, fig.cap = "Crude prevalence of ADHD in school data by health service, age band and sex. Bars show 95% normal confidence intervals.", fig.height = 10, fig.width = 8.5}
# ADHD
adhd_prev_health.agecat_sex <- get_grouped_prev_plot(x = chile_bayes_adhd, 
                                          grouping_vars = c("health_service_name", "age_cat_name", "sex_desc", "adhd"),
                                          disease = "adhd") %>%
...
```{r prevAgeHealthAutPlot, include = FALSE, fig.cap = "Crude prevalence of autism in school data by health service, age and sex. Bars show 95% normal confidence intervals.", fig.height=10, fig.width=8.5}
# Single ages
...
```{r prevAgeHealthAdhdPlot, include = FALSE, fig.cap = "Crude prevalence of ADHD in school data by health service, age and sex. Bars show 95% normal confidence intervals.", fig.height=10, fig.width=8.5}
# Single ages
...
```{r prevAgecatEconAAutPlot, fig.cap = "Crude prevalence of autism in school data by student's monthly school fee (Peso), age band and sex. Bars show 95% normal confidence intervals.", fig.height=6}
# Autism
aut_prev_econA.agecat_sex <- get_grouped_prev_plot(x = chile_bayes_aut,
                                                    grouping_vars = c("school_fee", "age_cat_name", "sex_desc", "autism"),
                                                    disease = "autism") %>%
...
```{r prevAgecatEconAAdhdPlot, fig.cap = "Crude prevalence of ADHD in school data by student's monthly school fee (Peso), age band and sex. Bars show 95% normal confidence intervals.", fig.height=6}
# ADHD
adhd_prev_econA.agecat_sex <- get_grouped_prev_plot(x = chile_bayes_adhd,
                                                    grouping_vars = c("school_fee", "age_cat_name", "sex_desc", "adhd"),
                                                    disease = "adhd") %>%
...
```{r prevAgeEconAAutPlot, include = FALSE, fig.cap = "Crude prevalence of autism in school data by socio-economic (SES) status of student's family, age and sex. Bars show 95% normal confidence intervals.", fig.height=6}
# Single ages
...
```{r prevAgeEconAAdhdPlot, include = FALSE, fig.cap = "Crude prevalence of ADHD in school data by socio-economic (SES) status of student's family, age and sex. Bars show 95% normal confidence intervals.", fig.height=6}
# Single ages
...
```{r prevAgecatEthnicAutPlot, fig.cap = "Crude prevalence of autism in school data by ethnicity, age band and sex. Bars show 95% normal confidence intervals. Regions with high Mapuche populations only.", fig.height=3}
# Autism
aut_prev_ethnic.agecat_sex <- get_grouped_prev_plot(x = chile_bayes_aut_ethnic,
                                                    grouping_vars = c("ethnic_2_group", "age_cat_name", "sex_desc", "autism"),
                                                    disease = "autism") %>%
...
```{r prevAgecatEthnicAdhdPlot, fig.cap = "Crude prevalence of ADHD in school data by ethnicity, age band and sex. Bars show 95% normal confidence intervals. Regions with high Mapuche populations only.", fig.height=3}
# ADHD
adhd_prev_ethnic.agecat_sex <- get_grouped_prev_plot(x = chile_bayes_adhd_ethnic,
                                                    grouping_vars = c("ethnic_2_group", "age_cat_name", "sex_desc", "adhd"),
                                                    disease = "adhd") %>%
...
```{r prevAgeEthnicAutPlot, include = FALSE, fig.cap = "Crude prevalence of autism in school data by ethnicity, age and sex. Bars show 95% normal confidence intervals.", fig.height=3}
# Single ages
...
```{r prevAgeEthnicAdhdPlot, include = FALSE, fig.cap = "Crude prevalence of ADHD in school data by ethnicity, age and sex. Bars show 95% normal confidence intervals.", fig.height=3}
# Single ages
...
```{r prevAgecatRuralAutPlot, fig.cap = "Crude prevalence of autism in school data by school's rurality, age band and sex. Bars show 95% normal confidence intervals.", fig.height=3}
# Autism
aut_prev_rural.agecat_sex <- get_grouped_prev_plot(x = chile_bayes_aut,
                                                    grouping_vars = c("school_rurality", "age_cat_name", "sex_desc", "autism"),
                                                    disease = "autism") %>%
...
```{r prevAgecatRuralAdhdPlot, fig.cap="Crude prevalence of ADHD in school data by school's rurality, age band and sex. Bars show 95% normal confidence intervals.", fig.height=3}
# By age and sex
# Age categories
adhd_prev_rural.agecat_sex <- get_grouped_prev_plot(x = chile_bayes_adhd,
                                                    grouping_vars = c("school_rurality", "age_cat_name", "sex_desc", "adhd"),
...
```{r prevAgeRuralAutPlot, include = FALSE, fig.cap = "Crude prevalence of autism in school data by school's rurality, age and sex. Bars show 95% normal confidence intervals.", fig.height=3}
# Single ages
...
```{r prevAgeRuralAdhdPlot, include = FALSE, fig.cap = "Crude prevalence of ADHD in school data by school's rurality, age and sex. Bars show 95% normal confidence intervals.", fig.height=3}
# Single ages
...
```{r adjPrevPlot, include = FALSE, fig.cap = "Crude and age- and sex-adjusted sample prevalence of autism and ADHD in school data. Bars for crude prevalence show 95% normal confidence intervals and bars for adjusted prevalence show 95% gamma confidence intervals.", fig.height=5}
...
```{r adjPrevSexPlot, include = FALSE, fig.cap = "Crude and age- and sex-adjusted sample prevalence of autism and ADHD in school data by sex. Bars for crude prevalence show 95% normal confidence intervals and bars for adjusted prevalence show 95% gamma confidence intervals.", fig.height=5}
# Females
...
```{r adjPrevHealthAutPlot, include = FALSE, fig.cap = "Crude and age- and sex-adjusted sample prevalence of autism in school data by health service. Bars for crude prevalence show 95% normal confidence intervals and bars for adjusted prevalence show 95% gamma confidence intervals."}
# Autism
...
```{r adjPrevHealthAdhdPlot, include = FALSE, fig.cap = "Crude and age- and sex-adjusted sample prevalence of ADHD in school data by health service. Bars for crude prevalence show 95% normal confidence intervals and bars for adjusted prevalence show 95% gamma confidence intervals."}
# ADHD
...
```{r adjPrevEconAAutPlot, include = FALSE, fig.cap = "Crude and age- and sex-adjusted sample prevalence of autism in school data by socio-economic (SES) status of student's family. Bars for crude prevalence show 95% normal confidence intervals and bars for adjusted prevalence show 95% gamma confidence intervals."}
# Autism
...
```{r adjPrevEconAAdhdPlot, include = FALSE, fig.cap = "Crude and age- and sex-adjusted sample prevalence of ADHD in school data by socio-economic (SES) status of student's family. Bars for crude prevalence show 95% normal confidence intervals and bars for adjusted prevalence show 95% gamma confidence intervals."}
# ADHD
...
```{r adjPrevEthnicAutPlot, include = FALSE, fig.cap = "Crude and age- and sex-adjusted sample prevalence of autism in school data by ethnicity. Bars for crude prevalence show 95% normal confidence intervals and bars for adjusted prevalence show 95% gamma confidence intervals."}
...
```{r adjPrevEthnicAdhdPlot, include = FALSE, fig.cap = "Crude and age- and sex-adjusted sample prevalence of ADHD in school data by ethnicity. Bars for crude prevalence show 95% normal confidence intervals and bars for adjusted prevalence show 95% gamma confidence intervals."}
# ADHD
...
```{r adjPrevRuralAutPlot, include = FALSE, fig.cap = "Crude and age- and sex-adjusted sample prevalence of autism in school data by school's rurality. Bars for crude prevalence show 95% normal confidence intervals and bars for adjusted prevalence show 95% gamma confidence intervals."}
# Autism
...
```{r adjPrevRuralAdhdPlot, include = FALSE, fig.cap = "Crude and age- and sex-adjusted sample prevalence of ADHD in school data by school's rurality. Bars for crude prevalence show 95% normal confidence intervals and bars for adjusted prevalence show 95% gamma confidence intervals."}
# ADHD
