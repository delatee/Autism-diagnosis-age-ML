...
Autism prevalence varies across health services. It is highest in Ñuble at `r round(aut_prev_health_adj$crude_rate[29] * 100, 2)`% (x - x%) and Antofagasta at x%(x-x%), and is lowest in Metropolitano Norte at .... and Araucanía Norte at ... . Autism peaks in the youngest ages across all services except Chiloé and Magallenes.

ADHD prevalence also varies across health services and is highest in ... and ..., and lowest in ... and ... .
...
```{r adj prev plot health agecat aut, fig.cap = "Sample prevalence of autism by health service, age band and sex. Bars show 95% normal confidence intervals.", fig.height = 11, fig.width = 8}
# Autism
...
```{r adj prev plot health agecat adhd, fig.cap = "Sample prevalence of ADHD by health service, age band and sex. Bars show 95% normal confidence intervals.", fig.height = 11, fig.width = 8}
# ADHD
...
For school fees, which are used here as a proxy for SES, autism prevalence is highest, at ..., among
...
```{r adj prev plot rate, fig.cap = "Crude and age- and sex-adjusted sample prevalences of autism and ADHD. Bars for crude prevalence show 95% normal confidence intervals and bars for adjusted prevalence show 95% gamma confidence intervals.", fig.height=5}
...
```{r adj prev plot rate sex, fig.cap = "Crude and age- and sex-adjusted sample prevalences of autism and ADHD by sex. Bars for crude prevalence show 95% normal confidence intervals and bars for adjusted prevalence show 95% gamma confidence intervals.", fig.height=5}
# Females
...
```{r adj prev araucS, include = FALSE}
...
```{r adj prev araucS plot aut agecat, fig.cap = "Sample prevalence of autism by commune in Araucanía Sur health service, age band and sex. Bars show 95% normal confidence intervals.", include = FALSE}
# By age and sex
# Age categories
...
```{r adj prev araucS plot aut rate, fig.cap = "Crude and age- and sex-adjusted sample prevalences of autism by commune in Araucanía Sur health service. Bars for crude prevalence show 95% normal confidence intervals and bars for adjusted prevalence show 95% gamma confidence intervals.", include = FALSE}
# All
