...
aut_prev_region <- get_grouped_prev(x = chile_bayes_aut, stdpop = chile_stdpop, 
                                    grouping_vars = c("school_region_name_abr", "age_june30", "age_cat_name", "sex", "autism"))
...
aut_prev_health <- get_grouped_prev(x = chile_bayes_aut, stdpop = chile_stdpop, 
                                    grouping_vars = c("health_service_name", "age_june30", "age_cat_name", "sex", "autism"))
...
aut_prev_rural <- get_grouped_prev(x = chile_bayes_aut, stdpop = chile_stdpop, 
                                    grouping_vars = c("school_rurality_code", "age_june30", "age_cat_name", "sex", "autism"))
...
aut_prev_ethnic <- chile_bayes_aut %>%
  ...
  get_grouped_prev(stdpop = chile_stdpop, 
                   grouping_vars = c("ethnic_2_group", "age_june30", "age_cat_name", "sex", "autism"))
...
aut_prev_econ <- get_grouped_prev(x = chile_bayes_aut, stdpop = chile_stdpop, 
                                    grouping_vars = c("school_fee", "school_fee_group", "age_june30", "age_cat_name", "sex", "autism"))
